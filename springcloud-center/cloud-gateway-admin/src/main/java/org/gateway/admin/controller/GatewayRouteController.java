package org.gateway.admin.controller;
...
import org.gateway.admin.entity.form.GatewayRouteForm;
import org.gateway.admin.entity.form.GatewayRouteQueryForm;
...
public class GatewayRouteController {
    ...
    public Result get(@PathVariable String id) {
        log.info("id 从数据库查 101 开始 get with id:{}", id);
